    ...
    try {
      ...
      setTimeout(() => {
        dialog.showMessageBox(mainWindow, {
          ...
          detail: 'System will automatically shutdown in 90 seconds (1 minute 30 seconds).\n\nPlease save your work and log out of any other applications.',
          buttons: ['OK']
        });
      }, 500);
      ...
      setTimeout(async () => {
        ...
        if (platform === 'win32') {
          shutdownCommand = 'shutdown /s /t 90 /c "Session ended. System will shutdown in 90 seconds (1 minute 30 seconds)."';
        } else if (platform === 'linux') {
          shutdownCommand = 'sudo shutdown -h +2 "Session ended. System shutting down in approximately 2 minutes."';
